# Set workspaces 1/2/3 -> monitor 1, workspaces 4/5/6/7/8/9 -> monitor 0 in glazewm config.
...
busybox sed -i -b -E `
    ...
    -e '/name: "7"/,/bind_to_monitor:/ s/bind_to_monitor:[^[:cntrl:]]*/bind_to_monitor: 0/' `
    -e '/name: "8"/,/bind_to_monitor:/ s/bind_to_monitor:[^[:cntrl:]]*/bind_to_monitor: 0/' `
    -e '/name: "9"/,/bind_to_monitor:/ s/bind_to_monitor:[^[:cntrl:]]*/bind_to_monitor: 0/' `
    $config

Write-Host "Set OFFICE layout: workspaces 1/2/3 -> monitor 1, workspaces 4/5/6/7/8/9 -> monitor 0"
