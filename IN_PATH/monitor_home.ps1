# Set workspaces 1/2/3 -> monitor 0, workspaces 4/5/6 -> monitor 1 in glazewm config.
...
Write-Host "Set HOME layout: workspaces 1/2/3 -> monitor 0, workspaces 4/5/6 -> monitor 1"
