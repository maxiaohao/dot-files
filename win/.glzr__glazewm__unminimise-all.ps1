...
$UnspecifiedSkipProcessRegex = '^(ms-teams|msteams|Teams|OUTLOOK|olk|wezterm-gui|wezterm|WindowsTerminal|WindowsApp|msrdcw|msrdc|mstsc|devenv|msedge|Code|ONENOTE|goldendict|CodeFlow|ShareX|zebar|PowerToys|Lively|EXCEL|WINWORD|POWERPNT)$'
