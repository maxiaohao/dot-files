...
-- Appearance
c.appearance.color                    = { red = 0.805, green = 0.363, blue = 0.0 }    -- Indicator background color, e.g., {red = 0.5, blue = 0 }
c.appearance.alpha                    = 0.7                 -- Opacity of active indicators
c.appearance.dimmer                   = 10                  -- Higher numbers increase contrast b/n focused & unfocused state
c.appearance.iconDimmer               = 1.6                 -- Higher numbers dim inactive icons *less* than the non-icon indicators
c.appearance.showIcons                = true                -- Window indicator style ('lozenge'-shaped when false)
c.appearance.size                     = 20                  -- Size of window indicators (height when icons off)
c.appearance.radius                   = 0                   -- Indicator roundness. Higher numbers → *less* roundness… I'm sorry
c.appearance.iconPadding              = 2                   -- Space between icon & indicator edge. Higher numbers → smaller, more inset icons
c.appearance.pillThinness             = 1                   -- Aspect ratio of pill-style icons (width = size / pillThinness)
...
c.appearance.offset.y                 = 96                  -- Distance from top of the window to render indicators
c.appearance.offset.x                 = 0                   -- Distance away from the edge of the window to render indicators
